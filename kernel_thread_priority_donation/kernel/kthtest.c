...
test_hello(void *arg)
{
  ...
  TEST_END;
//  printf("test_hello(): lets acquire\n");
  TEST_DONE;
}
...
//--------------------------------------------------------
// Test 10: donate_multicore
//--------------------------------------------------------


// M
void 
test_donate_mc_funcB(void *arg)
{
  struct slocks *sl = (struct slocks *) arg;
  TEST_BEGIN;
  printf("hart %d funcB\n", cpuid());
...
void
test_donate_multicore(void *arg)
{
  struct slocks sl;
  ...
  V_CREATE("A", KERN_DEF_PRIO - 1 , test_donate_mc_funcA, (void *) &sl);
  V_CREATE("B", KERN_DEF_PRIO - 10, test_donate_mc_funcB, (void *) &sl);
  V_CREATE("C", KERN_DEF_PRIO - 20, test_donate_mc_funcC, (void *) &sl.b);

  printf("settings finished, let's race\n");
